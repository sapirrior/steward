...
import { loadSessionLog, buildSessionPresentationProjection } from '../../session/logs/store.js';
import type { TurnPresentationEnd } from '../../session/logs/types.js';
import { rehydrateSessionHistory } from '../../session/helpers.js';
import {
  formatTurnStatus,
  formatSystemMessage,
  formatErrorBadge,
